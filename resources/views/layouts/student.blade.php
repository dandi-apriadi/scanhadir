    ...
    <main class="md:ml-72 min-h-screen relative">
        ...
        <header class="w-full sticky top-0 z-40 flex justify-between items-center px-8 py-4 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-xl shadow-sm dark:shadow-none">
            <div class="flex flex-col">
                <span class="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] font-label">Dashboard Overview</span>
                <h2 class="text-xl font-bold tracking-tight text-indigo-700 dark:text-indigo-400 font-headline">Student Portal</h2>
            </div>
            <div class="flex items-center gap-4">
                <button class="p-2 text-slate-500 hover:bg-slate-200/50 transition-colors rounded-full relative">
                ...
                <div class="flex items-center gap-3 pr-2">
                    <div class="text-right hidden sm:block">
                        <p class="text-sm font-bold text-on-surface">{{ $student_name ?? 'Student' }}</p>
                        <p class="text-[10px] text-slate-400 font-medium">Student • {{ $class ?? '-' }}</p>
                    </div>
                    <img alt="Student Profile Avatar" class="w-10 h-10 rounded-xl object-cover ring-2 ring-primary/10" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDXlLwOeOVe1zP4wmCSIX50RAmUHP7v4fQHocUPNZdY7oXGTGWDPz2JF3In0KqPsW64TrnSyUSmcZS9Clpkik0PbaWJZ33m2hU3MvthipH1s2JVPfEgbyfYGcINArLmx0NtvT9laJSwm4TlEeHAm0ryhnfx4T09PCc58ZOHr2k1nIRVaLb34ADnoAuDB_cAJfhQ3J5bfxmJU5FNYJ3fGVHP99qszRckuTK_gh183GYy413aBjeI8tL308p0oanuid1FrKUJ0bguz8wS"/>
                </div>
                <a href="{{ route('landing') }}" class="p-2 text-slate-500 hover:bg-slate-200/50 transition-colors rounded-full">
