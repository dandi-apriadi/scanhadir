...
<body class="bg-surface font-body text-on-surface antialiased">
    <aside class="hidden md:flex flex-col h-screen w-72 fixed left-0 top-0 bg-indigo-950 text-white z-50 py-8 gap-2">
        ...
        <nav class="flex-1 flex flex-col gap-1 px-4">
            <p class="text-[10px] uppercase tracking-[0.2em] text-indigo-400 font-bold mb-2 px-4">Main Menu</p>
            ...
            <a class="flex items-center gap-4 {{ request()->routeIs('admin.logs') ? 'bg-primary-container text-white' : 'text-indigo-200 hover:bg-white/10' }} rounded-xl px-4 py-3 transition-all" href="{{ route('admin.logs') }}">
                ...
                <span class="font-medium text-sm">Presensi Logs</span>
            </a>
            <a class="flex items-center gap-4 {{ request()->routeIs('admin.izin_approval') ? 'bg-primary-container text-white' : 'text-indigo-200 hover:bg-white/10' }} rounded-xl px-4 py-3 transition-all" href="{{ route('admin.izin_approval') }}">
                ...
                <span class="font-medium text-sm">Izin Approval</span>
            </a>

            <p class="text-[10px] uppercase tracking-[0.2em] text-indigo-400 font-bold mt-6 mb-2 px-4">Master Data</p>
            ...
            <p class="text-[10px] uppercase tracking-[0.2em] text-indigo-400 font-bold mt-6 mb-2 px-4">System</p>
