    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-5 flex flex-col gap-6">
            <div class="bg-surface-container-low rounded-xl p-6 relative overflow-hidden">
                ...
                <div class="relative">
                    <input class="w-full bg-surface-container-lowest border-none ring-1 ring-outline-variant/20 rounded-xl px-4 py-3 focus:ring-primary focus:ring-offset-0 transition-all text-sm font-medium" placeholder="Ketik NISN atau Nama..." type="text" value="{{ $student_name }}"/>
                </div>
            </div>
        ...
        <div class="lg:col-span-7">
            <div class="bg-surface-container-lowest rounded-2xl p-8 shadow-sm ring-1 ring-slate-100 flex flex-col gap-8">
                <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="relative">
                            <input class="w-full bg-slate-50 border-none ring-1 ring-slate-200 rounded-xl px-4 py-3 text-sm font-medium focus:ring-primary" type="time" value="07:15"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <textarea class="w-full bg-slate-50 border-none ring-1 ring-slate-200 rounded-xl px-4 py-3 text-sm font-medium focus:ring-primary transition-all" placeholder="Contoh: Lupa membawa kartu, Masalah transportasi, dsb." rows="3"></textarea>
                </div>
                ...
                <div class="flex items-center justify-between pt-4 border-t border-slate-50">
                    ...
                    <button class="bg-primary text-white px-10 py-4 rounded-xl font-bold text-sm tracking-wide shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-3">
